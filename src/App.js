...
const Interactions = () => {
    ...
    const urlGlobal = "https://ddi.medic.fun/";
    ...
    const compareInteractions = () => {
        ...
        axios
            .get(`${urlGlobal}compare/drugs_mnn?` + getParams)
            .then((response) => {
    ...
    const searchAutoComplite = (inputs) => {
        console.log(inputs);
        axios
            .get(`${urlGlobal}compare/drugs_search?drug=` + inputs)
            .then((response) => {
                const compares = response.data;
                setAutoComplite(Object.values(compares));
            })
            .catch((error) =>
                console.log("autoComplite error", error)
            );
    };
    return (
                ...
                <Box className={classes.content}>
                    <Box className={classes.titleBox}>
                        <Typography variant="h5">
                            Проверка взаимодействия лекарственных
                            средств
                        </Typography>
                    </Box>
                    <Grid
                    ...
                    >
                        ...
                        >
                            ...
                            <Box
                                className={
                                    classes.activePart__inputBox
                                }
                            >
                                {inputs.map((item, index) => (
                                    <Box
                                        className={
                                            classes.activePart__inputBox_item
                                        }
                                        key={index}
                                    >
                                        <Autocomplete
                                        ...
                                        {item.close == false ? (
                                            ...
                                            <Button
                                                variant="contained"
                                                className={
                                                    classes.activePart__cancelButton
                                                }
                                                onClick={() => {
                                                    handleDelete(
                                                        item.id
                            ...
                            <Box
                                className={
                                    classes.activePart__ButtonBox
                                }
                            >
                                <Button
                                    variant="contained"
                                    className={
                                        classes.activePart__Button
                                    }
                                    onClick={() => {
                                        addInput();
                                    }}
                        ...
                        >
                            ...
                            <Box className={classes.InfoBlock}>
                                <Typography variant="body1">
                                    Классификация взаимодействия с
                                    лекарствами
                                </Typography>
                                <Typography variant="body2">
                                    Эти классификации являются лишь
                                    ориентировочными. Уместность
                                    взаимодействия конкретных лекарств
                                    сложно определить для конкретного
                                    человека. Всегда консультируйтесь
                                    со своим врачом перед началом или
                                    завершением приема каких-либо
                                    лекарств.{" "}
                                </Typography>
                                <Box
                                    className={
                                        classes.InfoBlock_Content
                                    }
                                >
                                    {arrayInfoDrug.map(
                                        (item, index) => (
